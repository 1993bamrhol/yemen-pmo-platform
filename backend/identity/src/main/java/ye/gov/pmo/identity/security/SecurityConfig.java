    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/error", "/api/auth/**", "/api/portal/**", "/api/news/**", "/api/announcements/**", "/api/decisions/**", "/api/documents/**", "/api/v1/entities/**", "/api/v1/entity-types", "/api/v1/services", "/api/v1/services/**", "/api/v1/content", "/api/v1/content/**", "/actuator/health", "/health").permitAll()
